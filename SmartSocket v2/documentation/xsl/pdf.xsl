...
<xsl:param name="admon.graphics">1</xsl:param>
  ...
  <xsl:param name="admon.graphics.path">c:/Program Files (x86)/DocBook Doclet//docbook/xsl/images/</xsl:param>
  <xsl:param name="admon.textlabel">1</xsl:param>
  <xsl:param name="callout.graphics">1</xsl:param>
  <xsl:param name="callout.graphics.extension">.gif</xsl:param>
  <xsl:param name="callout.graphics.path">c:/Program Files (x86)/DocBook Doclet//docbook/xsl/images/callouts/</xsl:param>
  ...
  <xsl:param name="draft.watermark.image">c:/Program Files (x86)/DocBook Doclet//docbook/xsl/images/draft.png</xsl:param>
