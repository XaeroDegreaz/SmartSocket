...
package net.smartsocket.smartlobby.lobby
{
	...
	
	{
		...
		public function Lobby($customGameListColumns:Array = null, $customGameListColumnWidths:Array = null)
		{
			...
			try{
				SmartLobbyClient.customListeners["server"].initCustomLobbyFunctions();
			}catch(e) {
		...
		public function init(e:Event) {			
			SmartLobbyClient.customListeners["server"].joinRoom(0);
		}
		...
		public function onCreateRoom(e:SmartLobbyEvent):void {
			...
			SmartLobbyClient.my.createdRoom = room._id;
...
//			}
			...
			SmartLobbyClient.customListeners["server"].joinRoom(room._id);
		}
		...
		public function onRoomJoin(e:SmartLobbyEvent):void {
			...
			SmartLobbyClient.my.room = room.ID;
			SmartLobbyClient.customListeners["server"].getUserList();
			
			if(room.ID != 0) {
				gl.switchTo("tl");
				SmartLobbyClient.customListeners["server"].getTeamList();
				SmartLobbyClient.customListeners["server"].joinTeam("unassigned");
							
			}else {
				SmartLobbyClient.my.createdRoom = null;
				gl.switchTo("gl");
				SmartLobbyClient.customListeners["server"].getRoomList();
			}
		}
...
//				}
		...
		public function onTeamList(e:SmartLobbyEvent):void {
		 ...
		 public function onTeamListChange(e:SmartLobbyEvent):void {
		 	...
		 	if(o.Username == SmartLobbyClient.my.Username) {
		 		
		 		SmartLobbyClient.my.Team = o.To;
		 		trace("This is me, my team is now "+SmartLobbyClient.my.Team);
		 	}
		 }
